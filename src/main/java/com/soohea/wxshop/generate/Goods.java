...
public class Goods {
     ...
     * @mbg.generated Sun Jun 19 14:52:57 CST 2022
     */
    public Goods(Long id, Long shopId, String name, String description, String imgUrl, Long price, Integer stock, String status, Date createdAt, Date updatedAt) {
        this.id = id;
        this.shopId = shopId;
        this.name = name;
     ...
     * @mbg.generated Sun Jun 19 14:52:57 CST 2022
     */
    public Goods(Long id, Long shopId, String name, String description, String imgUrl, Long price, Integer stock, String status, Date createdAt, Date updatedAt, String details) {
        this.id = id;
        this.shopId = shopId;
        this.name = name;
        this.description = description;
